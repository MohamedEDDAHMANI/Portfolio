...
const footer = () => {
  return (
    <div className='w-[90%] h-[200px] mx-auto flex justify-center items-center flex flex-col border-l-2 border-r-2 border-accent'>
      <h1 className='text-accent text-[20px] font-bold'>Code is art</h1>
      <h1 className='text-[13px]'>©2024 MohamedEddahmani</h1>
      <h1 className='w-[50%] text-[15px] text-center text-gray-500'>
